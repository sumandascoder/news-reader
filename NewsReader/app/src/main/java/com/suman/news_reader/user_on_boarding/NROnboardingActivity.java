    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT <= Build.VERSION_CODES.LOLLIPOP)
            mNextBtn.setImageDrawable(
                    tintMyDrawable(ContextCompat.getDrawable(this, R.drawable.ic_next), Color.WHITE)
            );
        ...
        mSkipBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                finish();
                saveSharedSetting(NROnboardingActivity.this, ImageLaunchActivity.PREF_USER_FIRST_TIME, "false");
                Intent imageCapture = new Intent(getApplicationContext(), ImageLaunchActivity.class);
